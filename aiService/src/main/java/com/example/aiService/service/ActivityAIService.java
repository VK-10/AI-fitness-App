...
public class ActivityAIService {
        ...
        try {
            ...
            JsonNode textNode = rootNode.path("candidates")
                ...
                String jsonContent = textNode.asText()
                        ...
                        .replaceAll("\\n```", "")
                        .trim();
            //log.info("Parsed response from AI: {}", aiResponse);
    ...
    private Recommendation createDefaultRecommendation(Activity activity) {
        return Recommendation.builder()
                ...
                .improvements(Collections.singletonList("Continue with your daily routine"))
                .suggestions(Collections.singletonList("Consider consulting the professional"))
    ...
    private List<String> extractSafetyGuideLine(JsonNode safetyNode) {
        ...
        return safety.isEmpty() ?
                Collections.singletonList("No specific safety provided but follow general Safety Guidelines") :
                safety;
    }
