...
function ActivityForm({ onActivityAdded }) {
  ...
  return (
    ...
    <TextField fullWidth label="Calories Burnt" type = 'number' sx = {{mb: 2}} value={activity.caloriesBurned} onChange={(e) => setActivity({...activity, caloriesBurned: e.target.value})}/>
